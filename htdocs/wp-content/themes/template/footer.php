  ...
  <div class="l-footer">
    ...
    <div class="u-layout">
      ...
      <div class="l-footer__icon-container">
        ...
        <a href="https://web.facebook.com/jenelleloise/" class="l-footer__icon-container__icon"><img src="<?php echo get_template_directory_uri(); ?>/data/img/common/fb.svg" alt="fb"></a>
        <a href="https://github.com/jenelleabrigo" class="l-footer__icon-container__icon"><img src="<?php echo get_template_directory_uri(); ?>/data/img/common/github.svg" alt="github"></a>
        <a href="https://www.linkedin.com/in/jenelleloiseabrigo/" class="l-footer__icon-container__icon"><img src="<?php echo get_template_directory_uri(); ?>/data/img/common/linkedin.svg" alt="linkedin"></a>
      </div>
    </div>
